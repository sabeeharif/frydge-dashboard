...
const DeleteCategoryModal = ({ open, onClose, onDelete,isLoading,setIsLoading }) => {
  if (!open) return null;
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="w-[350px] bg-white rounded-[20px] p-6 shadow-lg flex flex-col items-center gap-5">
        ...
        <div className="flex gap-4 mt-4">
          ...
          <button
            onClick={onDelete}
            className="w-[120px] flex h-[45px] rounded-[50px] justify-center items-center bg-red-500 text-white font-[Montserrat] font-medium text-[16px]"
          >
